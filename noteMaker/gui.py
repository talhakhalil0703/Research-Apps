...
exit_button = Button(window, text = 'Close App', fg ='red', command = exit_clicked)
write_button = Button(window, text = 'Write Values', command = write_clicked)
remove_last_button = Button(window, text = 'Remove Last Line', command = remove_last_clicked)
next_trajectory = Button(window, text = 'Clear Values', command = next_trajectory_clicked)
#read_button = Button(window, text = 'Show File', command = read_button_clicked)
...
exit_button.grid(column = 5, row = 2)
...
save_edits_button.grid(column = 0, row = 2)
